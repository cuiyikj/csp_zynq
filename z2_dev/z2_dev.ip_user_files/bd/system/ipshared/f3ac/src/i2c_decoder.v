...
module i2c_decoder (
        ...
        if (~i_res_n) begin
            ...
            // DATA and ACK Flag
                ...
                case (r_i2c_state)
                    ...
                    2: r_wdata <= 8'h20;    // SP
                    3: r_wdata <= r_i2c_rx_byte[0] ? 8'h4e : 8'h59; // ACK or NAK
                    4: begin
                        r_wdata <= 8'h20;   // SP
                        r_i2c_data_ack_busy <= 1'b0;
                        r_i2c_rx_bit_cnt <= 4'd0;
    ...
    assign i2c_db = r_fifo_wen;
    assign i2c_db_scl = i_i2c_scl;
    assign i2c_db_sda = i_i2c_sda;
    assign i2c_db_start = w_i2c_start;
    assign i2c_db_stop = w_i2c_stop;
endmodule
