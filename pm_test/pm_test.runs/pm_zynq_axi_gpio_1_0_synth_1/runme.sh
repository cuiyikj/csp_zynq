...
HD_PWD='C:/git/csp_zynq/pm_test/pm_test.runs/pm_zynq_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pm_zynq_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pm_zynq_axi_gpio_1_0.tcl
