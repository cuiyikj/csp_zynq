...
HD_PWD='C:/project/zynq/pm_test/pm_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pm_zynq_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pm_zynq_wrapper.tcl
