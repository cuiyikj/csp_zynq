...
HD_PWD='C:/project/zynq/pm_test/pm_test.runs/pm_zynq_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pm_zynq_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pm_zynq_processing_system7_0_0.tcl
