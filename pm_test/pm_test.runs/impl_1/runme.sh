...
HD_PWD='C:/project/zynq/pm_test/pm_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pm_zynq_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pm_zynq_wrapper.tcl -notrace
