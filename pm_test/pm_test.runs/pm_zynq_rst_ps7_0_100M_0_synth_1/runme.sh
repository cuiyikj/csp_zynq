...
HD_PWD='C:/project/zynq/pm_test/pm_test.runs/pm_zynq_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pm_zynq_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pm_zynq_rst_ps7_0_100M_0.tcl
